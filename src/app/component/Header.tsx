        ...
        <div>
            <div>
                <ul data-orientation="horizontal"
                    className="flex justify-between w-full text-sm gap-x-2 md:gap-x-4 navigation relative z-[100] text-black" dir="ltr">
                    <li className="grow"><Link className="inline-block px-2 -mx-2 pt-2 pb-1.5 -my-2 text-inherit" href="/"
                            data-radix-collection-item=""><svg viewBox="0 0 141 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                aria-label="Composer Logo" className="h-6 logo-animated">
                                <path id="graph-1" d="M4.72867 17.5484H0.599609V21.9355H4.72867V17.5484Z" fill="currentColor">
                                </path>
                                ...
                                <path id="gradient-1" d="M4.72916 11.8711H0.600098V13.6775H4.72916V11.8711Z" fill="currentColor">
                                </path>
                                <path id="gradient-2" d="M10.6647 5.93555H0.600098V8.38716H10.6647V5.93555Z" fill="currentColor">
                                </path>
                    ...
                    <li><Link className="hidden sm:block py-0.5 px-2 transition duration-300 rounded-full hover:bg-black/10 font-medium focus:bg-black/10 h-min"
                            data-radix-collection-item="" href="/crypto/">Crypto</Link></li>
                    <li><Link className="hidden sm:block py-0.5 px-2 transition duration-300 rounded-full hover:bg-black/10 font-medium focus:bg-black/10 h-min navigation-item"
                            data-radix-collection-item="" href="/retirement/">Retirement</Link></li>
                    <li><Link className="hidden sm:block py-0.5 px-2 transition duration-300 rounded-full hover:bg-black/10 font-medium focus:bg-black/10 h-min"
                            data-radix-collection-item="" href="/pricing/">Pricing</Link></li>
                    <li
                        className="hidden sm:block py-0.5 px-2 transition duration-300 rounded-full hover:bg-black/10 font-medium focus:bg-black/10 h-min">
                        <button id="radix-:Rp6:-trigger-radix-:Rh6p6:" data-state="open" aria-expanded="true"
                            aria-controls="radix-:Rp6:-content-radix-:Rh6p6:" data-radix-collection-item=""><span
                                className="pb-0 sm:pb-0 flex items-center justify-between w-full gap-1">Resources<svg
                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 256 256" className="w-6 md:w-4">
                                    <rect width="256" height="256" fill="none"></rect>
                                    <polyline points="208 96 128 176 48 96" fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16"></polyline>
                                </svg></span></button><span aria-hidden="true"></span>
                        <div
                            className="opacity-0 hidden sm:flex sm:translate-y-0 pointer-events-none dropdown-content w-full sm:absolute sm:w-64 sm:ml-[-88px] transition-all sm:pt-2 sm:-mt-2">
                            <div data-orientation="horizontal"
                                className="text-black delay-75 transition-all w-full font-normal tracking-wide text-2xl sm:text-sm sm:bg-white sm:border border-black/20 sm:rounded-md sm:px-2 sm:py-2 sm:drop-shadow-md">
                                <div>
                                    <ul data-orientation="horizontal"
                                        className="w-full space-y-2 pt-4 sm:pt-0 mt-4 sm:mt-0 border-t sm:border-none border-dashed border-black/20">
                                        <div className="w-full space-y-1">
                                            <li><Link className="font-semibold inline-block w-full hover:bg-black/10 rounded transition duration-300 sm:py-1 sm:px-2"
                                                    data-radix-collection-item="" href="/blog/">Blog</Link></li>
                                        </div>
                                        <div className="w-full space-y-1">
                                            <li><Link className="font-semibold inline-block w-full hover:bg-black/10 rounded transition duration-300 sm:py-1 sm:px-2"
                                                    data-radix-collection-item="" href="/etf/">ETF Database</Link></li>
                                        </div>
                                        <div className="w-full space-y-1">
                                            <li><Link className="font-semibold inline-block w-full hover:bg-black/10 rounded transition duration-300 sm:py-1 sm:px-2"
                                                    data-radix-collection-item="" href="/etf-comparisons/">ETF Comparisons</Link></li>
                                        </div>
                                        <div className="w-full space-y-1">
                                            <li><Link className="font-semibold inline-block w-full hover:bg-black/10 rounded transition duration-300 sm:py-1 sm:px-2"
                                                    data-radix-collection-item="" href="/learn/">Learn</Link></li>
                                            <li><Link className="inline-block w-full opacity-70 py-1 px-2 hover:bg-black/10 transition rounded duration-300"
                                                    data-radix-collection-item="" href="/learn/all-about-investing/">All About
                                                    Investing</Link></li>
                                            <li><Link className="inline-block w-full opacity-70 py-1 px-2 hover:bg-black/10 transition rounded duration-300"
                                                    data-radix-collection-item="" href="/learn/artificial-intelligence/">Artificial
                                                    Intelligence (AI)</Link></li>
                                            <li><Link className="inline-block w-full opacity-70 py-1 px-2 hover:bg-black/10 transition rounded duration-300"
                                                    data-radix-collection-item="" href="/learn/comparison/">Comparison</Link></li>
                                            <li><Link className="inline-block w-full opacity-70 py-1 px-2 hover:bg-black/10 transition rounded duration-300"
                                                    data-radix-collection-item="" href="/learn/trading-strategies/">Trading
                                                    Strategies</Link></li>
                                            <li><Link className="inline-block w-full opacity-70 py-1 px-2 hover:bg-black/10 transition rounded duration-300"
                                                    data-radix-collection-item="" href="/learn/algorithmic-trading/">Algorithmic
                                                    Trading</Link></li>
                                            <li><Link className="inline-block w-full opacity-70 py-1 px-2 hover:bg-black/10 transition rounded duration-300"
                                                    data-radix-collection-item="" href="/learn/stock-market-and-etfs/">Stock Market
                                                    &amp; ETFs</Link></li>
                                        </div>
                                        <div className="w-full space-y-1">
                                            <li><Link className="font-semibold inline-block w-full hover:bg-black/10 rounded transition duration-300 sm:py-1 sm:px-2"
                                                    data-radix-collection-item="" href="/help/">Help</Link></li>
                                            <li><Link target="_blank" rel="noopener noreferrer"
                                                    className="inline-block w-full opacity-70 py-1 px-2 hover:bg-black/10 transition rounded duration-300"
                                                    data-radix-collection-item=""
                                                    href="https://composer.trade/help/support">Support</Link></li>
                                        </div>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <li><Link className="hidden sm:block py-0.5 px-2 transition duration-300 rounded-full hover:bg-black/10 font-medium focus:bg-black/10 h-min"
                            data-radix-collection-item="" href="https://app.composer.trade/login">Login</Link></li>
                    <li><Link className="py-0.5 px-2 transition duration-300 rounded-full font-semibold hover:bg-green-mid hidden sm:block  text-white bg-black"
                            data-radix-collection-item="" href="https://app.composer.trade/register">Sign Up</Link></li>
                    <li className="sm:hidden"><button type="button" aria-pressed="false" data-state="closed"
                            id="radix-:Rp6:-trigger-radix-:R26p6:" aria-expanded="false"
                            aria-controls="radix-:Rp6:-content-radix-:R26p6:"
                            className="py-0.5 px-2 transition duration-300 rounded-full font-semibold hover:bg-green-mid sm:hidden  text-white bg-black"
